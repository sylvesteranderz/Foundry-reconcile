      ...
      <div className="relative">
        ...
        <Input
          ...
          classNames={{
            ...
            inputWrapper: `border dark:border-[#F5F5F580] bg-white focus-visible:ring-[#619B7D] disabled:cursor-not-allowed disabled:opacity-50 ${height}`,
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full border flex flex-col rounded-md text-sm justify-center">
        <textarea
          className="bg-white h-[100px] rounded w-full px-2 py-1 outline-none focus:border-none"
          {...(inputProps ?? {})}
    ...
    <div className="flex flex-col gap-3">
      ...
      <label
        ...
        <div className="flex flex-row items-center my-auto w-full relative">
          ...
          {value && (
            <div className="flex flex-col items-center gap-y-1 hover:underline w-full">
              <Icon icon="solar:file-linear" width="24" height="24" />
